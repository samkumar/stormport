...
implementation
{
    ...
    components new HplSam4lUSARTP(0x40024000, 0, 0) as usart0;
    components new HplSam4lUSARTP(0x40028000, 1, 1) as usart1;
    components new HplSam4lUSARTP(0x4002C000, 2, 2) as usart2;
    components new HplSam4lUSARTP(0x40030000, 0, 3) as usart3;
    ...
    hal_usart0.uart -> usart0;
    hal_usart1.uart -> usart1;
    hal_usart2.uart -> usart2;
    hal_usart3.uart -> usart3;
